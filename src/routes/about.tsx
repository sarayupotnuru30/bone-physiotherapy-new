...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Learn about our mission, our specialists, and our patient-first approach to physiotherapy and orthopaedic care." },
      { property: "og:title", content: "About — Bone Physiotherapy" },
      { property: "og:description", content: "Care designed around you — clinical expertise meets a patient-first philosophy." },
    ],
  }),
  component: AboutPage,
});
