...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Book your consultation. Reach our team via phone, email, or WhatsApp." },
      { property: "og:title", content: "Contact — Bone Physiotherapy" },
      { property: "og:description", content: "Take the first step toward recovery — book your consultation today." },
    ],
  }),
    ...
    <section className="py-16 md:py-20">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {CONTACT_CARDS.map((c) => {
            const content = (
              <div className="flex h-full flex-col rounded-2xl border border-border bg-card p-6 shadow-[var(--shadow-soft)] transition-all hover:-translate-y-1 hover:shadow-[var(--shadow-elegant)]">
        ...
        <div className="mt-14 grid gap-6 lg:grid-cols-5">
          <div className="lg:col-span-3 rounded-3xl border border-border bg-card p-8 shadow-[var(--shadow-soft)] md:p-10">
            <h2 className="font-heading text-2xl font-bold text-foreground">Send us a message</h2>
            <p className="mt-2 text-sm text-muted-foreground">Fill in your details and we'll send your request via WhatsApp.</p>
            ...
            <form onSubmit={handleSubmit} className="mt-6 grid gap-5 sm:grid-cols-2">
              ...
              <div className="sm:col-span-2">
                ...
                <textarea
                  id="message" rows={4} maxLength={1000}
