...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Expert physiotherapy and orthopaedic care across orthopaedic, neurological, sports, and elderly wellness specialties." },
      { property: "og:title", content: "Bone Physiotherapy — Restore Movement, Relieve Pain" },
      { property: "og:description", content: "Advanced physiotherapy and orthopaedic care for a pain-free, active life." },
    ],
  }),
  component: HomePage,
});
